...
playersRef.on("value", function(snapshot) {
  ...
  if (playerOneExists) {
    ...
    $("#player1-name").parent().attr("class", "border border-success");
    $("#player1-wins").text("Wins: " + playerOneData.wins);
    $("#player1-losses").text("Losses: " + playerOneData.losses);
  } else {
    // If there is no player 1, clear win/loss data and show waiting
    $("#player1-name").text("Waiting for Player 1");
    $("#player1-name").parent().attr("class", "border border-danger");
    $("#player1-wins").empty();
  ...
  if (playerTwoExists) {
    ...
    $("#player2-name").parent().attr("class", "border border-success");
    $("#player2-wins").text("Wins: " + playerTwoData.wins);
    $("#player2-losses").text("Losses: " + playerTwoData.losses);
  } else {
    // If no player 2, clear win/loss and show waiting
    $("#player2-name").text("Waiting for Player 2");
    $("#player2-name").parent().attr("class", "border border-danger");
    $("#player2-wins").empty();
  ...
  if (playerNum) {
    ...
    if (currentTurn === 1) {
      ...
      if (currentTurn === playerNum) {
        ...
        $("#player" + playerNum + " ul").append("<li class=\"list-group-item\">Rock</li><li class=\"list-group-item\">Paper</li><li class=\"list-group-item\">Scissors</li>");
      } else {
      ...
      $("#player1").attr("class", "border border-warning");
      $("#player2").attr("class", "border border-dark");
      ...
      // Shows yellow border around active player
      $("#player2").attr("class", "border border-warning");
      $("#player1").attr("class", "border border-dark");
      ...
      $("#player2").attr("class", "border border-secondary");
      $("#player1").attr("class", "border border-secondary");
    }
  }
});
